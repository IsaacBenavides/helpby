...
import 'package:mydoctor/tab/model/page_view_model.dart';
import 'package:mydoctor/tab/ui/intro_button.dart';
import 'package:mydoctor/tab/ui/intro_page.dart';
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: _height > 800
                ? _height - _height * 0.4
                : (_height <= 800 && _height >= 725)
                    ? _height - _height * 0.35
                    : (_height < 725 && _height >= 672)
                        ? _height - _height * 0.30
                        : (_height < 672 && _height >= 586)
                            ? _height - _height * 0.20
                            : (_height < 672 && _height >= 586)
                                ? _height - _height * 0.15
                                : _height - _height * 0.10,
            left: 16.0,
            right: 16.0,
            child: SafeArea(
              child: Row(
